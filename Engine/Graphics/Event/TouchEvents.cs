...
namespace Yna.Engine.Graphics.Event
{
    ...
    public class TouchEntityEventArgs : EventArgs
    {
        ...
        /// </summary>
        public TouchEntityEventArgs(float x, float y, int fingerId)
        {
            X = x;
            Y = y;
            FingerId = fingerId;
    ...
    /// </summary>
    public class TouchActionEventArgs : TouchEntityEventArgs
    {
        /// <summary>
        ...
        public TouchActionEventArgs(float x, float y, int fingerId, bool pressed, bool moved, bool released, float pressure)
            : base(x, y, fingerId)
        {
            Pressed = pressed;
            Moved = moved;
